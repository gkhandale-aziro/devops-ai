...
export function AIDrawer({ open, context, title, onClose }: Props) {
  ...
  return (
    <>
      ...
      <div
        onClick={onClose}
        style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.33)", zIndex: 140 }}
      />
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontSize: FONT_SIZE.sm, color: "var(--c-accent)", fontWeight: FONT_WEIGHT.bold, textTransform: "uppercase", letterSpacing: ".5px" }}>AI Analysis</div>
            <div style={{ fontSize: FONT_SIZE.sm, color: C.text.secondary, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{title}</div>
          </div>
          ...
          {loading && (
            <div style={{ display: "flex", alignItems: "center", gap: SPACE.sm, flexShrink: 0 }}>
              ...
              <span style={{ fontSize: FONT_SIZE.sm, color: C.accent.light }}>Analyzing…</span>
            </div>
          )}
          ...
          <button
            ...
            style={{
              ...
              borderRadius: RADIUS.md, color: C.text.secondary,
        ...
        <div
          ...
          aria-live="polite"
          aria-busy={loading}
          style={{ flex: 1, overflowY: "auto", padding: `${SPACE.xl}px ${SPACE.xl}px` }}
        >
          {text ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: SPACE.sm, paddingTop: SPACE.xs }}>
              {[90, 75, 95, 60, 80].map((w, i) => (
                <div key={i} style={{ height: FONT_SIZE.md, width: `${w}%`, background: "var(--c-bg-active)", borderRadius: RADIUS.sm, animation: "shimmer 1.4s infinite" }} />
              ))}
            </div>
          ) : (
            <div style={{ color: C.text.muted, fontSize: FONT_SIZE.md, textAlign: "center", paddingTop: 40 }}>—</div>
          )}
        </div>
        ...
        <div style={{
          ...
          <label htmlFor="aidrawer-followup" style={{ display: "block", fontSize: FONT_SIZE.xs, color: C.text.muted, marginBottom: SPACE.sm, textTransform: "uppercase", letterSpacing: ".5px" }}>
            Ask a follow-up
          </label>
          <div style={{
          ...
          >
            <input
              ...
              style={{
                ...
                color: C.text.primary, fontSize: FONT_SIZE.md, fontFamily: "inherit",
              }}
            />
            <button
              onClick={askFollowUp}
              ...
              style={{
                ...
                width: 30, height: 30,
                color: "#fff", fontWeight: FONT_WEIGHT.bold, fontSize: FONT_SIZE.lg,
