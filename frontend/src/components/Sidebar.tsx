...
export function Sidebar({ targets, activeId, onSelect, onRemove, onEdit, onAddClick, monitorActive, aiModel, onModelChange, modelStatus = "healthy" }: Props) {
    ...
    return (
      <Link
        ...
        style={{
          ...
          padding: `${SPACE.sm - 1}px ${SPACE.md}px`, borderRadius: RADIUS.md, fontSize: FONT_SIZE.md,
  ...
  return (
    <nav aria-label="Main navigation" style={{
      ...
      {/* ── Logo ───────────────────────────────────────────────────────────── */}
      <div style={{
        padding: `${SPACE.md + 2}px ${SPACE.lg}px ${SPACE.md}px`,
      ...
      {/* ── Nav ────────────────────────────────────────────────────────────── */}
      <div style={{ padding: `${SPACE.md - 6}px ${SPACE.sm}px`, display: "flex", flexDirection: "column", gap: 1, flexShrink: 0 }}>
      ...
      {/* ── Connections header ─────────────────────────────────────────────── */}
      <div style={{
        padding: `${SPACE.sm + 2}px ${SPACE.lg}px ${SPACE.md - 6}px`,
